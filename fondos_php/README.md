...
- 🔄 **Auto-Switching Product Deck & Interactive Visuals**: Stacked product deck featuring category filters (`FT POSP Sure`, `FT D2C Insure`, `FT Lending Insure`, `FT Embedded Insure`, `FT Digital Claims`, `FT PayIn-PayOut`, `FT EB Sure`, `FT Compliance Shield`, `FT Reconciliation`), custom dropdown menu for mobile/tablet, and high-impact visual showcases:
  ...
  - 💳 **FT PayIn-PayOut 5-Image Showcase**: Layered 5-screen composite visual pairing Main Dashboard (`FT_PayIn_PayOut_Img_1.png`), Settlement Status Donut Chart (`FT_PayIn_PayOut_Img_4.png`), Recent Payouts List Modal (`FT_PayIn_PayOut_Img_5.png`), Pay-In Channels Grid (`FT_PayIn_PayOut_Img_3.png`), and Today's Overview Widget (`FT_PayIn_PayOut_Img_2.png`) with one-time viewport entrance animations (`payoutPop1`–`payoutPop5`), light borders, and responsive scaling across desktop, tablet, and mobile.
  - 👥 **FT EB Sure 4-Card & 3-Pill Showcase**: Layered composite visual pairing Self-Service Enrolment (`FT_EB_Sure_Img_1.png`), Dependent Management (`FT_EB_Sure_Img_2.png`), Claims Tracking (`FT_EB_Sure_Img_3.png`), and Renewals Overview (`FT_EB_Sure_Img_4.png`) with 3 floating feature badges (`Easy Employee Enrollment`, `Real-Time Claims Tracking`, `50% Less Admin Work`) with one-time viewport entrance animations (`ebPop1`–`ebPop4`, `ebPillPop1`–`ebPillPop3`), light borders, and responsive scaling across desktop, tablet, and mobile.
  - 🛡️ **FT Compliance Shield 4-Image Showcase**: Layered 4-screen composite visual pairing Main Dashboard (`FT_Compliance_Shield_Img_1.png`), Compliance Status Badge (`FT_Compliance_Shield_Img_5.png`), Report Types Modal (`FT_Compliance_Shield_Img_3.png`), and Regulatory Reports Widget (`FT_Compliance_Shield_Img_2.png`) with one-time viewport entrance animations (`compliancePop1`, `compliancePop5`, `compliancePop3`, `compliancePop2`), light borders, and responsive scaling across desktop, tablet, and mobile.
  - 📊 **FT Reconciliation 5-Image Showcase**: Layered 5-screen composite visual pairing Import Insurer Statements Modal (`FT_Reconciliation_Img_1.png`), Payout Processing Modal (`FT_Reconciliation_Img_2.png`), Commission Matching Donut Chart Modal (`FT_Reconciliation_Img_5.png`), Mismatches & Alerts Modal (`FT_Reconciliation_Img_3.png`), and Payouts Sent Successfully Modal (`FT_Reconciliation_Img_4.png`) with one-time viewport entrance animations (`reconPop1`–`reconPop5`), light blue borders (`#CEE4FD`), soft elevated shadows, and responsive scaling across desktop, tablet, and mobile breakpoints.
  - 👁️ **Viewport Scroll Observer (`initPillViewportObserver`)**: `IntersectionObserver` engine inside `home.js` triggering module animations once when scrolled into view.
...
- ⚡ **Section 5 — AI In Loan-Linked Insurance Suite (`AI IN LOAN-LINKED INSURANCE`)**: 4 interactive feature cards for AI-Powered Cover Matching, AI-Powered Foreclosure Detection, Automated Refund Calculation, and Insurtech-Native Architecture.
- 🎯 **Section 6 — Segment Grid (`BUILT FOR`)**: 4 target segment cards (Banks, NBFCs, Insurance Brokers, Insurance Agencies) with a bottom Scale Flow Bar.
- ⚖️ **Section 7 — Side-by-Side Comparison Grid (`THE DIFFERENCE`)**: Dual-card view contrasting *Without FT Lending Insure* against *⚡ With FT Lending Insure* (`RECOMMENDED`).
