...
<!-- ============================================= -->
<section class="posp-hero-section" id="lending-hero">
            ...
            <div class="col-lg-6 text-start" data-aos="fade-right">
                ...
                <div
                    ...
                    <span class="fw-semibold text-uppercase tracking-wider"
                        style="font-size: 0.78125rem; color: #086ad8;">EMBEDDED INSURANCE SOFTWARE FOR LENDERS</span>
                </div>

                <h1 class="posp-hero-title mb-3">
                    FT Lending Insure — <span class="text-primary-custom">Insurance, Attached at Disbursement.</span>
                </h1>

                <p class="section-desc mb-4" style="max-width: 600px; margin-left: 0;">
                    AI-powered embedded insurance software that attaches credit life and asset protection cover the moment a loan is disbursed, manages claims and foreclosure cancellations automatically, and keeps every policy tied to the loan it protects.
                </p>
                ...
                <div class="d-flex align-items-center gap-3 flex-wrap posp-hero-trust-row"
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <span>Instant Cover at Disbursement</span>
                    </div>
                    <div class="d-flex align-items-center gap-2">
                        <span class="badge rounded-circle d-inline-flex align-items-center justify-content-center text-primary-custom" style="width: 22px; height: 22px; font-size: 0.75rem; background-color: rgba(8, 106, 216, 0.12);">✓</span>
                        <span>Automated Foreclosure Refunds</span>
                    </div>
                    <div class="d-flex align-items-center gap-2">
                        <span class="badge rounded-circle d-inline-flex align-items-center justify-content-center text-primary-custom" style="width: 22px; height: 22px; font-size: 0.75rem; background-color: rgba(8, 106, 216, 0.12);">✓</span>
    ...
    <div class="container">
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                <div class="about-card posp-challenge-card d-flex flex-column h-100 p-4 border-2">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        ...
                        <span class="pillar-tag-badge">DELAYED ATTACHMENT</span>
                    </div>

                    <h3 class="about-card-title mb-2" style="min-height: 3.25rem;">Cover Lags Behind Disbursement</h3>
                    <p class="about-card-text flex-grow-1 mb-4">
                        When insurance is added manually after a loan is disbursed, there's a window where the borrower and the loan are uncovered.
                    </p>
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="150">
                <div class="about-card posp-challenge-card d-flex flex-column h-100 p-4 border-2">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        ...
                        <span class="pillar-tag-badge">MISSED CANCELLATIONS</span>
                    </div>

                    <h3 class="about-card-title mb-2" style="min-height: 3.25rem;">Foreclosures Don't Trigger Refunds</h3>
                    <p class="about-card-text flex-grow-1 mb-4">
                        When a loan is foreclosed early, the linked insurance often isn't cancelled — leaving unclaimed refunds and unhappy borrowers.
                    </p>

                    <div class="pt-3 border-top d-flex align-items-center justify-content-between"
                        style="border-color: #cee4fd !important;">
                        <span class="text-muted" style="font-size: 0.8125rem;">Impact Level</span>
                        <span class="fw-bold text-primary-custom" style="font-size: 0.875rem;">💰 Refund Leakage Risk</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                <div class="about-card posp-challenge-card d-flex flex-column h-100 p-4 border-2">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        ...
                        <span class="pillar-tag-badge">SLOW CLAIMS</span>
                    </div>

                    <h3 class="about-card-title mb-2" style="min-height: 3.25rem;">Claims Stall Without Loan Context</h3>
                    <p class="about-card-text flex-grow-1 mb-4">
                        Without a direct link between the loan and the policy, claims processing slows down while teams manually verify loan status.
                    </p>
        ...
        <div class="mt-4 p-3 p-sm-4 rounded-4 bg-light border text-center shadow-sm" style="border-color: #cee4fd !important;"
            ...
            <div class="d-flex align-items-center justify-content-center gap-2 flex-wrap"
                ...
                <span class="text-dark">Manual loan-insurance attachment leaves coverage gaps and missed refunds</span>
                <span class="text-primary-custom d-none d-sm-inline">➔</span>
                <span class="text-primary-custom fw-bold">FT Lending Insure connects both automatically, from disbursement to closure</span>
            </div>
        </div>
    </div>
</section>
...
<section class="posp-how-it-works-section" id="how-it-works">
    <div class="container">
        <div class="section-header text-center" data-aos="fade-up">
            ...
            <h2 class="section-title">From Loan Disbursement to Policy Closure — <span class="text-primary-custom">One Automated Flow</span></h2>
            <p class="section-desc mx-auto">Every stage of the loan-linked insurance lifecycle — from attachment to cancellation — flows through one connected system, tied directly to loan status.</p>
        </div>
        ...
        <div class="row g-4 mt-3">
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                <div class="about-card posp-step-card d-flex flex-column h-100 p-4 border-2">
                    ...
                    <h3 class="about-card-title mb-2" style="min-height: 3.25rem;">Loan Data Sync</h3>
                    <p class="about-card-text flex-grow-1 mb-0">
                        Loan disbursement data syncs automatically from your lending system — no manual entry to trigger cover.
                    </p>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="150">
                <div class="about-card posp-step-card d-flex flex-column h-100 p-4 border-2">
                    ...
                    <h3 class="about-card-title mb-2" style="min-height: 3.25rem;">AI-Powered Cover Attachment</h3>
                    <p class="about-card-text flex-grow-1 mb-0">
                        FT Lending Insure attaches the correct credit life or asset protection policy the moment the loan is disbursed.
                    </p>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                <div class="about-card posp-step-card d-flex flex-column h-100 p-4 border-2">
                    ...
                    <h3 class="about-card-title mb-2" style="min-height: 3.25rem;">Real-Time Claims Intake</h3>
                    <p class="about-card-text flex-grow-1 mb-0">
                        Claims are raised directly against the linked loan and policy, with AI verifying loan status before processing.
                    </p>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="250">
                <div class="about-card posp-step-card d-flex flex-column h-100 p-4 border-2">
                    ...
                    <h3 class="about-card-title mb-2" style="min-height: 3.25rem;">Foreclosure Detection</h3>
                    <p class="about-card-text flex-grow-1 mb-0">
                        When a loan is foreclosed or closed early, the system detects it automatically and flags the linked policy for cancellation.
                    </p>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                <div class="about-card posp-step-card d-flex flex-column h-100 p-4 border-2">
                    ...
                    <h3 class="about-card-title mb-2" style="min-height: 3.25rem;">Automated Refund Triggers</h3>
                    <p class="about-card-text flex-grow-1 mb-0">
                        Once a cancellation is confirmed, eligible premium refunds are calculated and triggered automatically.
                    </p>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="350">
                <div class="about-card posp-step-card d-flex flex-column h-100 p-4 border-2">
                    ...
                    <h3 class="about-card-title mb-2" style="min-height: 3.25rem;">Audit-Ready Reporting</h3>
                    <p class="about-card-text flex-grow-1 mb-0">
                        Every attachment, claim, and cancellation produces a clean, exportable report, ready for review.
                    </p>
                </div>
            </div>
        </div>
...
<!-- ============================================= -->
<!-- SECTION 4: MANAGING LOAN-LINKED INSURANCE    -->
<!-- ============================================= -->
<section class="posp-dashboard-section" id="dashboard">
    <div class="container">
        <div class="section-header text-center" data-aos="fade-up">
            <div class="section-label">MANAGING LOAN-LINKED INSURANCE, DAY TO DAY</div>
            <h2 class="section-title">Everything Your Lending Team Needs To <span class="text-primary-custom">Protect Every Loan</span></h2>
            <p class="section-desc mx-auto">Dual-view architecture designed for borrower transparency and lender control.</p>
        </div>
            ...
            <div class="col-lg-6" data-aos="fade-right" data-aos-delay="100">
                <div class="about-card posp-dashboard-card h-100 p-4 border-2">
                    <div class="d-flex align-items-center gap-3 mb-4 pb-3 border-bottom"
                        ...
                        <div>
                            <span class="pillar-tag-badge mb-1">BORROWER INTERFACE</span>
                            <h3 class="about-card-title mb-0" style="font-size:1.35rem;">For The Borrower</h3>
                        </div>
                    </div>
            ...
            <div class="col-lg-6" data-aos="fade-left" data-aos-delay="150">
                <div class="about-card posp-dashboard-card h-100 p-4 border-2">
                    <div class="d-flex align-items-center gap-3 mb-4 pb-3 border-bottom"
                        ...
                        <div>
                            <span class="pillar-tag-badge mb-1">LENDER CONTROL CONSOLE</span>
                            <h3 class="about-card-title mb-0" style="font-size:1.35rem;">For The Bank / NBFC</h3>
                        </div>
                    </div>
                    <div class="d-flex flex-column gap-3">
                        <div class="pillar-check-item">
        ...
        <div class="mt-4 p-3 p-sm-4 rounded-4 bg-light border text-center shadow-sm" style="border-color: #cee4fd !important;"
            ...
            <div class="d-flex align-items-center justify-content-center gap-2 flex-wrap"
                ...
                <span class="badge px-2.5 py-1.5 rounded-pill fw-bold text-primary-custom border"
                    style="background-color: #ffffff; border-color: #cee4fd !important; font-size: 0.8125rem;">👤 Borrower Coverage View</span>
                <span class="text-muted fw-bold">+</span>
                <span class="badge px-2.5 py-1.5 rounded-pill fw-bold text-primary-custom border"
                    style="background-color: #ffffff; border-color: #cee4fd !important; font-size: 0.8125rem;">📋 Lender Admin Console</span>
            </div>
        </div>
    </div>
</section>
...
<!-- ============================================= -->
<!-- SECTION 5: AI IN LOAN-LINKED INSURANCE        -->
<!-- ============================================= -->
<section class="posp-ai-section" id="ai-features">
    <div class="container">
        <div class="section-header text-center" data-aos="fade-up">
            <div class="section-label">AI IN LOAN-LINKED INSURANCE</div>
            <h2 class="section-title">AI That Keeps Cover <span class="text-primary-custom">In Sync With Every Loan</span></h2>
            <p class="section-desc mx-auto">FT Lending Insure isn't a bolt-on policy tracker — it's insurtech built with AI at the core.</p>
        </div>
        ...
        <div class="row g-4 mt-2">
            ...
            <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
                <div class="about-card posp-ai-card d-flex flex-column h-100 p-4 border-2">
                    ...
                    <h3 class="about-card-title mb-2" style="min-height: 2.75rem;">AI-Powered Cover Matching</h3>
                    <p class="about-card-text flex-grow-1 mb-0">
                        Matches every disbursed loan to the correct protection policy automatically, based on loan type and amount.
                    </p>
                </div>
            </div>
            ...
            <div class="col-lg-6" data-aos="fade-up" data-aos-delay="150">
                <div class="about-card posp-ai-card d-flex flex-column h-100 p-4 border-2">
                    ...
                    <h3 class="about-card-title mb-2" style="min-height: 2.75rem;">AI-Powered Foreclosure Detection</h3>
                    <p class="about-card-text flex-grow-1 mb-0">
                        Identifies early loan closures automatically and flags the linked policy for cancellation.
                    </p>
                </div>
            </div>
            ...
            <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
                <div class="about-card posp-ai-card d-flex flex-column h-100 p-4 border-2">
                    ...
                    <h3 class="about-card-title mb-2" style="min-height: 2.75rem;">Automated Refund Calculation</h3>
                    <p class="about-card-text flex-grow-1 mb-0">
                        Calculates eligible premium refunds based on policy terms and cancellation date, triggering payouts automatically.
                    </p>
                </div>
            </div>
            ...
            <div class="col-lg-6" data-aos="fade-up" data-aos-delay="250">
                <div class="about-card posp-ai-card d-flex flex-column h-100 p-4 border-2">
                    ...
                    <p class="about-card-text flex-grow-1 mb-0">
                        Built on FondosTech's insurtech engine, connecting loan-linked insurance to claims and payout records already on the platform.
                    </p>
                </div>
            </div>
        </div>
...
<section class="posp-built-for-section" id="built-for">
    <div class="container">
        <div class="section-header text-center" data-aos="fade-up">
            ...
            <h2 class="section-title">One Loan Protection System, Every Kind of <span class="text-primary-custom">Lending Business</span></h2>
            <p class="section-desc mx-auto">Empowering banks, NBFCs, insurance brokers, and agencies alike.</p>
        </div>
        ...
        <div class="row g-4 mt-3">
            ...
            <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="100">
                <div class="about-card text-center p-4">
                    ...
                    <h3 class="about-card-title mb-2">Banks</h3>
                    <p class="about-card-text">
                        Attach credit life and asset cover automatically across every loan, with foreclosure cancellations handled automatically.
                    </p>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="150">
                <div class="about-card text-center p-4">
                    ...
                    <h3 class="about-card-title mb-2">NBFCs</h3>
                    <p class="about-card-text">
                        Offer embedded protection on every loan product, without a dedicated team managing attachment by hand.
                    </p>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="200">
                <div class="about-card text-center p-4">
                    ...
                    <p class="about-card-text">
                        Service lending partners' embedded programs at scale, with loan and policy data always in sync.
                    </p>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="250">
                <div class="about-card text-center p-4 h-100" style="border-color: #086ad8 !important; background: #f5faff;">
                    ...
                    <p class="about-card-text">
                        Manage loan-linked insurance portfolios for multiple lending partners from a single platform.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="mt-4 p-3 p-sm-4 rounded-4 bg-light border text-center shadow-sm" style="border-color: #cee4fd !important;"
            ...
            <div class="d-flex align-items-center justify-content-center gap-2 flex-wrap"
                style="font-weight: 600; font-size: 0.875rem;">
                <span class="text-dark fw-bold">Loan disbursed</span>
                <span class="text-primary-custom">➔</span>
                <span class="badge px-2.5 py-1.5 rounded-pill fw-bold text-primary-custom border"
                    style="background-color: #ffffff; border-color: #cee4fd !important; font-size: 0.8125rem;">AI attaches the correct policy instantly</span>
                <span class="text-primary-custom">➔</span>
                <span class="text-dark fw-bold">claims linked to loan status</span>
                <span class="text-primary-custom d-none d-sm-inline">➔</span>
                <span class="text-dark fw-bold d-none d-sm-inline">foreclosure triggers automatic cancellation &amp; refund</span>
            </div>
        </div>
    </div>
</section>
...
<section class="posp-comparison-section" id="difference">
    <div class="container" data-aos="fade-up">
        <div class="section-header text-center">
            ...
            <p class="section-desc mx-auto">Compare legacy manual loan-insurance handling with FT Lending Insure's automated platform.</p>
        </div>

        <div class="row g-4 mt-3">
            <!-- Left Side: WITHOUT FT LENDING INSURE -->
            <div class="col-lg-6" data-aos="fade-right" data-aos-delay="100">
                <div class="about-card h-100 p-4 border-2"
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-4 pb-3 border-bottom"
                        ...
                        <div class="d-flex align-items-center gap-2">
                            <span class="badge bg-secondary-subtle text-dark px-3 py-2 rounded-pill fw-bold"
                                style="font-size: 0.875rem; background-color: #f1f5f9 !important;">WITHOUT FT LENDING INSURE</span>
                        </div>
                    ...
                    <div class="d-flex flex-column gap-3">
                        <div class="pillar-check-item" style="background: #f8fafc; border-color: #e2e8f0;">
                            ...
                            <div class="text-muted">Insurance attached manually, after disbursement</div>
                        </div>
                        <div class="pillar-check-item" style="background: #f8fafc; border-color: #e2e8f0;">
                            <span class="check-icon" style="background: #94a3b8; color: #ffffff;">✕</span>
                            <div class="text-muted">Coverage gaps between disbursement and cover start</div>
                        </div>
                        <div class="pillar-check-item" style="background: #f8fafc; border-color: #e2e8f0;">
                            <span class="check-icon" style="background: #94a3b8; color: #ffffff;">✕</span>
                            <div class="text-muted">Foreclosures don't automatically cancel linked policies</div>
                        </div>
                        <div class="pillar-check-item" style="background: #f8fafc; border-color: #e2e8f0;">
                            <span class="check-icon" style="background: #94a3b8; color: #ffffff;">✕</span>
                            <div class="text-muted">Refunds requested manually, often missed entirely</div>
                        </div>
                        <div class="pillar-check-item" style="background: #f8fafc; border-color: #e2e8f0;">
                            <span class="check-icon" style="background: #94a3b8; color: #ffffff;">✕</span>
                            <div class="text-muted">Claims processed without direct loan-status verification</div>
                        </div>
                        <div class="pillar-check-item" style="background: #f8fafc; border-color: #e2e8f0;">
                            <span class="check-icon" style="background: #94a3b8; color: #ffffff;">✕</span>
                            <div class="text-muted">No unified view of loan-linked policies</div>
                        </div>
                        <div class="pillar-check-item" style="background: #f8fafc; border-color: #e2e8f0;">
                            <span class="check-icon" style="background: #94a3b8; color: #ffffff;">✕</span>
                            <div class="text-muted">Reporting compiled manually, per lender request</div>
                        </div>
                    </div>
                </div>
            </div>

            <!-- Right Side: WITH FT LENDING INSURE -->
            <div class="col-lg-6" data-aos="fade-left" data-aos-delay="150">
                <div class="about-card h-100 p-4 border-2 shadow-lg position-relative"
                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-4 pb-3 border-bottom"
                        ...
                        <div class="d-flex align-items-center gap-2">
                            <span class="badge bg-primary text-white px-2.5 px-sm-3 py-2 rounded-pill fw-bold"
                                style="font-size: 0.8125rem;">⚡ WITH FT LENDING INSURE</span>
                        </div>
                    ...
                    <div class="d-flex flex-column gap-3">
                        <div class="pillar-check-item" style="background: #f5faff; border-color: #cee4fd;">
                            <span class="check-icon">✓</span>
                            <div class="text-dark fw-bold">Insurance attached instantly, at disbursement</div>
                        </div>
                        <div class="pillar-check-item" style="background: #f5faff; border-color: #cee4fd;">
                            <span class="check-icon">✓</span>
                            <div class="text-dark fw-bold">Zero-gap coverage from day one of the loan</div>
                        </div>
                        <div class="pillar-check-item" style="background: #f5faff; border-color: #cee4fd;">
                            <span class="check-icon">✓</span>
                            <div class="text-dark fw-bold">Foreclosures trigger automatic policy cancellation</div>
                        </div>
                        <div class="pillar-check-item" style="background: #f5faff; border-color: #cee4fd;">
                            <span class="check-icon">✓</span>
                            <div class="text-dark fw-bold">Refunds calculated and released automatically</div>
                        </div>
                        <div class="pillar-check-item" style="background: #f5faff; border-color: #cee4fd;">
                            <span class="check-icon">✓</span>
                            <div class="text-dark fw-bold">Claims verified against live loan status instantly</div>
                        </div>
                        <div class="pillar-check-item" style="background: #f5faff; border-color: #cee4fd;">
                            <span class="check-icon">✓</span>
                            <div class="text-dark fw-bold">Full loan-linked portfolio, visible on one dashboard</div>
                        </div>
                        <div class="pillar-check-item" style="background: #f5faff; border-color: #cee4fd;">
                            <span class="check-icon">✓</span>
...
<!-- ============================================= -->
<section class="faq-section section-padding" id="faq" aria-label="Loan-Linked Insurance Questions Answered">
    <div class="container">
        <div class="row g-5">
            <!-- Left Sticky Sidebar -->
            <div class="col-lg-5 col-md-12 faq-left-column">
                <div class="faq-left-content">
                    ...
                    <h2 class="section-title">
                        Your Loan-Linked Insurance Questions, <span class="text-primary-custom">Answered</span>
                    </h2>
                    <p class="section-desc mb-4">
                        Everything you need to know about FT Lending Insure's attachment, claims, and cancellation process.
                    </p>
                    <a href="<?php echo $base_path; ?>contact.php"
            ...
            <div class="col-lg-7 col-md-12" data-aos="fade-left" data-aos-delay="150">
                <div class="accordion faq-accordion-custom" id="lendingFaqAccordion">
                    <!-- Item 1 -->
                    <div class="accordion-item faq-card-item" data-aos="fade-up" data-aos-delay="100">
                        <h3 class="accordion-header">
                            <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                data-bs-target="#lendFaq1" aria-expanded="true" aria-controls="lendFaq1">
                                What is embedded insurance software for lenders?
                            </button>
                        </h3>
                        <div id="lendFaq1" class="accordion-collapse collapse show" data-bs-parent="#lendingFaqAccordion">
                            <div class="accordion-body">
                                Embedded insurance software for lenders is a digital system that automatically attaches protection policies to disbursed loans, manages claims linked to loan status, and handles cancellations and refunds when a loan closes early — replacing manual attachment and tracking.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item faq-card-item" data-aos="fade-up" data-aos-delay="120">
                        <h3 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                data-bs-target="#lendFaq2" aria-expanded="false" aria-controls="lendFaq2">
                                How does FT Lending Insure use AI?
                            </button>
                        </h3>
                    ...
                    <div class="accordion-item faq-card-item" data-aos="fade-up" data-aos-delay="140">
                        <h3 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                data-bs-target="#lendFaq3" aria-expanded="false" aria-controls="lendFaq3">
                                Can borrowers track their coverage and claims directly?
                            </button>
                        </h3>
                    ...
                    <div class="accordion-item faq-card-item" data-aos="fade-up" data-aos-delay="160">
                        <h3 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                data-bs-target="#lendFaq4" aria-expanded="false" aria-controls="lendFaq4">
                                Is FT Lending Insure a standalone tool, or part of a larger platform?
                            </button>
                        </h3>
                    ...
                    <div class="accordion-item faq-card-item" data-aos="fade-up" data-aos-delay="180">
                        <h3 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                data-bs-target="#lendFaq5" aria-expanded="false" aria-controls="lendFaq5">
                                What happens to the insurance policy if a loan is foreclosed early?
                            </button>
                        </h3>
                    ...
                    <div class="accordion-item faq-card-item" data-aos="fade-up" data-aos-delay="200">
                        <h3 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                data-bs-target="#lendFaq6" aria-expanded="false" aria-controls="lendFaq6">
                                Does FT Lending Insure work for both credit life and asset insurance?
                            </button>
                        </h3>
                    ...
                    <div class="accordion-item faq-card-item" data-aos="fade-up" data-aos-delay="220">
                        <h3 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                data-bs-target="#lendFaq7" aria-expanded="false" aria-controls="lendFaq7">
                                Is FT Lending Insure insurtech, or a generic loan add-on tool?
                            </button>
                        </h3>
                    ...
                    <div class="accordion-item faq-card-item" data-aos="fade-up" data-aos-delay="240">
                        <h3 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                data-bs-target="#lendFaq8" aria-expanded="false" aria-controls="lendFaq8">
                                Does FT Lending Insure generate audit-ready reports?
                            </button>
                        </h3>
    ...
    <div class="container" data-aos="fade-up">
        <div class="about-cta-card">
            ...
            <p class="about-cta-desc">
                See how FT Lending Insure replaces manual attachment and tracking with one AI-powered loan protection system.
            </p>
