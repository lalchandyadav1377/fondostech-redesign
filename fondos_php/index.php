...
<section class="hero-section" id="hero" aria-label="Hero">
    <div class="container">
        <div class="hero-content">
            <h1 class="hero-title" data-aos="fade-up">The Insurance Software Built to Run Your Entire Brokerage</h1>
            <p class="hero-subtitle" data-aos="fade-up" data-aos-delay="50">
                FondosTech is end-to-end insurance software that brings quoting, POSP management, claims,
                reconciliation, payouts and IRDAI compliance onto a single platform — with AI built in where it
            ...
            <div class="hero-badges" data-aos="fade-up" data-aos-delay="200">
                <div class="badge-trust">
                    <svg class="badge-icon" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M6.5 1L8.045 4.13L11.5 4.635L9 7.07L9.59 10.51L6.5 8.885L3.41 10.51L4 7.07L1.5 4.635L4.955 4.13L6.5 1Z"
                            stroke="white" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                    <span class="badge-text">IRDAI-aligned workflows</span>
                </div>
                ...
                <div class="badge-trust">
                    ...
                    <span class="badge-text">Built for brokers, POSPs &amp; MGAs</span>
                </div>
                <svg class="badge-dot" viewBox="0 0 5 5" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="2.5" cy="2.5" r="2.5" fill="rgba(255,255,255,0.4)" />
                </svg>
                <div class="badge-trust">
                    ...
                    <span class="badge-text">One platform, every stage</span>
                </div>
            </div>
...
<section class="industries-section section-padding" id="industries" aria-label="Industries we serve">
    <div class="container">
        <div class="section-header text-center mx-auto" style="max-width: 700px;" data-aos="fade-up">
            <div class="section-label">INDUSTRY SPECIFIC WORKFLOWS</div>
            <h2 class="section-title">
                Platform For Every <span class="text-primary-custom">Insurance Player</span>
            </h2>
            <p class="section-desc mx-auto">Whether you're a carrier, MGA, broker, or enterprise looking to distribute
                insurance — we have a solution.</p>
        </div>
        ...
        <div class="row g-4 mt-2">
            ...
            <div class="col-lg-6 col-md-6" data-aos="fade-up" data-aos-delay="100">
                <div class="industry-card">
                    ...
                    <div class="industry-card-content">
                        <p class="industry-card-text"><strong>Problem:</strong> Streamline Insurance attachment journey
                            in loan disbursement process and offer value-added insurance products</p>
                        <p class="industry-card-text"><strong>Solution:</strong> Utilize our Lending Module to embed
                            sachet insurance and co-curate product as per use case (Credit life, Personal accident, EMI
                            Protect, etc.)</p>
                    </div>
            ...
            <!-- Row 3 Left (Extra): Logistics & Supply Chain -->
            <div class="col-lg-6 col-md-6 industry-extra-card d-none">
                <div class="industry-card">
                    <img src="assets/images/bank-nbfcs-hm-10.png" alt="" class="industry-card-bg" aria-hidden="true">
                    <div class="industry-card-icon-box">
                        <img src="assets/images/image-53.png" alt="Logistics Icon" width="38" height="38">
                    </div>
                    <h3 class="industry-card-title">Logistics &amp; Supply Chain</h3>
                    <div class="industry-card-divider"></div>
                    <div class="industry-card-content">
                        <p class="industry-card-text"><strong>Problem:</strong> Integrate instant transit insurance and
                            freight protection into booking &amp; dispatch workflows</p>
                        <p class="industry-card-text"><strong>Solution:</strong> Utilize our Cargo Insurance Module for
                            real-time shipment policy issuance with automated claim settlement</p>
                    </div>
                    <div class="industry-card-footer">
                        <a href="#" class="btn-link-custom">
                            Get Quote
            ...
            <!-- Row 3 Right (Extra): E-Commerce & Retail -->
            <div class="col-lg-6 col-md-6 industry-extra-card d-none">
                <div class="industry-card">
                    <img src="assets/images/bank-nbfcs-hm-10.png" alt="" class="industry-card-bg" aria-hidden="true">
                    <div class="industry-card-icon-box">
                        <img src="assets/images/image-60.png" alt="E-Commerce Icon" width="38" height="38">
                    </div>
                    <h3 class="industry-card-title">E-Commerce &amp; Retail</h3>
                    <div class="industry-card-divider"></div>
                    <div class="industry-card-content">
                        <p class="industry-card-text"><strong>Problem:</strong> Offer embedded buyer protection,
                            extended warranty, and return insurance during checkout</p>
                        <p class="industry-card-text"><strong>Solution:</strong> Embed purchase protection APIs into
                            cart checkout with instant micro-policy generation</p>
                    </div>
                    <div class="industry-card-footer">
                        <a href="#" class="btn-link-custom">
                            Get Quote
...
<section class="stats-section section-padding" id="stats" aria-label="Company statistics" data-aos="fade-up">
    <div class="container">
        ...
        <p class="section-desc" data-aos="fade-up" data-aos-delay="50">Loved and appreciated by thousands running their brokerage on FondosTech</p>
...
<!-- ============================================= -->
<section class="insurtech-section section-padding" id="insurtech" aria-label="AI-powered insurance features" data-aos="fade-up">
    <div class="container">
        <div class="insurtech-header text-center" data-aos="fade-up">
            <div class="insurtech-label">INSURTECH FOR INSURANCE</div>
            <h2 class="section-title text-white">The Insurtech Engine Behind Smarter Insurance Software</h2>
            <p class="insurtech-desc">
                Insurance is about understanding risk and helping people when it matters most. AI enhances both
                through personalized conversations, empathy, and end-to-end automation — helping brokers work faster,
        ...
        <div class="insurtech-cards-grid">
            ...
            <div class="insurtech-card" data-aos="fade-up" data-aos-delay="100">
                ...
                <p class="insurtech-card-desc">
                    AI helps your team move from generic quotes to hyperpersonalized recommendations, so brokers close
                    more business without spending more hours per lead.
                </p>
            </div>
            ...
            <div class="insurtech-card" data-aos="fade-up" data-aos-delay="150">
                ...
                <p class="insurtech-card-desc">
                    The simplicity of consumer insurtech apps, built for brokers, agents and corporates — no training
                    overhead.
                </p>
            </div>
            ...
            <div class="insurtech-card" data-aos="fade-up" data-aos-delay="250">
                ...
                <p class="insurtech-card-desc">
                    AI-assisted underwriting brings more consistency and speed to risk assessment on every policy.
                </p>
            </div>
            ...
            <div class="insurtech-card" data-aos="fade-up" data-aos-delay="300">
                ...
                <p class="insurtech-card-desc">
                    Seamless integration with 50+ insurers and regulatory platforms like Vahan — no manual re-entry, no
                    silos.
                </p>
            </div>
            ...
            <div class="insurtech-card" data-aos="fade-up" data-aos-delay="350">
                ...
                <p class="insurtech-card-desc">
                    The simplicity of consumer-grade insurtech apps, built for brokers, agents and corporates — no
                    training overhead.
                </p>
            </div>
        </div>
            ...
            <div class="container h-100 d-flex flex-column justify-content-center">
                <div class="row align-items-end mb-3" data-aos="fade-up">
                    <div class="col-lg-8">
                        ...
                        <h2 class="section-title">Enterprise-Ready for the entire pricing lifecycle</h2>
                        <p class="section-desc" style="max-width: 100%;">We powered by deep insurance expertise and
                            continuous program innovation, enables brands to launch, manage, and scale contextual
                            insurance experiences with unmatched speed and flexibility.</p>
                    </div>
                ...
                <div class="platform-deck-filters d-none d-lg-flex mb-3" id="platform-deck-filters" data-aos="fade-up" data-aos-delay="100">
                    <button class="platform-filter-btn active" data-category="insurance" data-target="0">
                        <img src="assets/images/mdi-umbrella-outline0.svg" alt="">
                        Insurance
                    </button>
                    <button class="platform-filter-btn" data-category="healthcare" data-target="1">
                        <img src="assets/images/jam-medical0.svg" alt="">
                        Healthcare
                    </button>
                    <button class="platform-filter-btn" data-category="lifesciences" data-target="2">
                        <img src="assets/images/tabler-microscope0.svg" alt="">
                        Lifesciences
                    </button>
                    <button class="platform-filter-btn" data-category="wellness" data-target="3">
                ...
                <div class="platform-deck-custom-dropdown dropdown d-lg-none mb-3" data-aos="fade-up" data-aos-delay="100">
                    <button class="btn btn-custom-filter-dropdown dropdown-toggle w-100" type="button" id="platformFilterDropdownBtn" data-bs-toggle="dropdown" aria-expanded="false">
                        <span class="dropdown-selected-content">
                            <img src="assets/images/mdi-umbrella-outline0.svg" alt="" id="dropdownSelectedIcon" width="20" height="20">
                            <span id="dropdownSelectedLabel">Insurance</span>
                        </span>
                        <svg class="dropdown-chevron" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M6 9l6 6 6-6"/></svg>
                    </button>
                    <ul class="dropdown-menu platform-dropdown-menu-custom w-100 shadow-lg border-0 mt-2" aria-labelledby="platformFilterDropdownBtn">
                        <li>
                            <button class="dropdown-item platform-custom-item active" type="button" data-target="0" data-label="Insurance" data-icon="assets/images/mdi-umbrella-outline0.svg">
                                <img src="assets/images/mdi-umbrella-outline0.svg" alt="" width="20" height="20">
                                <span>Insurance</span>
                            </button>
                        </li>
                        <li>
                            <button class="dropdown-item platform-custom-item" type="button" data-target="1" data-label="Healthcare" data-icon="assets/images/jam-medical0.svg">
                                <img src="assets/images/jam-medical0.svg" alt="" width="20" height="20">
                                <span>Healthcare</span>
                            </button>
                        </li>
                        <li>
                            <button class="dropdown-item platform-custom-item" type="button" data-target="2" data-label="Lifesciences" data-icon="assets/images/tabler-microscope0.svg">
                                <img src="assets/images/tabler-microscope0.svg" alt="" width="20" height="20">
                                <span>Lifesciences</span>
                            </button>
                        </li>
                        <li>
                            <button class="dropdown-item platform-custom-item" type="button" data-target="3" data-label="Corporate Wellness" data-icon="assets/images/uil-bag0.svg">
                ...
                <div class="platform-card-deck" id="platform-card-deck" data-aos="fade-up" data-aos-delay="150">
                    <!-- Card 1: Insurance -->
                    <div class="platform-deck-card pos-0" data-index="0" data-category="insurance">
                        <div class="platform-card">
                            <div class="row g-0 align-items-center">
                                <div class="col-lg-6">
                                    <div class="platform-card-body">
                                        <span class="platform-card-label">Policy</span>
                                        <h3 class="platform-card-title">Adapt with Speed. <span
                                                class="text-primary-custom">Scale with Ease.</span></h3>
                                        <p class="platform-card-desc">Trusted by leading insurers worldwide to
                                            accelerate product innovation, elevate underwriting accuracy, and deliver
                                            policies faster.</p>
                                        <div class="platform-features-list">
                                            <div class="platform-feature-item">
                                                <img src="assets/images/ic-outline-gpp-good0.svg" alt="">
                                                <span>Digital dashboards for policy &amp; claims management</span>
                                            </div>
                                            <div class="platform-feature-item">
                                                <img src="assets/images/group0.svg" alt="">
                                                <span>Multi-insurer support across product lines</span>
                                            </div>
                                            <div class="platform-feature-item">
                                                <img src="assets/images/material-symbols-money-bag-outline0.svg" alt="">
                                                <span>Auto-set rules for business distribution</span>
                                            </div>
                                            <div class="platform-feature-item">
                                                <img src="assets/images/mdi-invoice-fast-outline0.svg" alt="">
                                                <span>Real-time reporting &amp; compliance tracking</span>
                                            </div>
                                        </div>
                                        <a href="#" class="btn-link-custom">
                                            Explore More
                                ...
                                <div class="col-lg-6">
                                    <div class="platform-card-image">
                                        <img src="assets/images/insurance-policy-management-software-10.png"
                                            alt="Insurance policy management software dashboard">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- Card 2: Healthcare -->
                    <div class="platform-deck-card pos-1" data-index="1" data-category="healthcare">
                        <div class="platform-card">
                            <div class="row g-0 align-items-center">
                                <div class="col-lg-6">
                                    <div class="platform-card-body">
                                        <span class="platform-card-label">Healthcare</span>
                                        <h3 class="platform-card-title">Adapt with Speed. <span
                                                class="text-primary-custom">Scale with Ease.</span></h3>
                                        <p class="platform-card-desc">Trusted by leading insurers worldwide to
                                            accelerate product innovation, elevate underwriting accuracy, and deliver
                                ...
                                <div class="col-lg-6">
                                    <div class="platform-card-image">
                                        <img src="assets/images/insurance-policy-management-software-11.png"
                                            alt="Healthcare policy management dashboard">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- Card 3: Lifesciences -->
                    <div class="platform-deck-card pos-2" data-index="2" data-category="lifesciences">
                        <div class="platform-card">
                            <div class="row g-0 align-items-center">
                                <div class="col-lg-6">
                                    <div class="platform-card-body">
                                        ...
                                        <h3 class="platform-card-title">Adapt with Speed. <span
                                                class="text-primary-custom">Scale with Ease.</span></h3>
                                        <p class="platform-card-desc">FondosTech’s AI engine instantly matches each
                                            customer with the best-fit policy, turning routine quotes into
                                            hyperpersonalized recommendations.</p>
                                        <div class="platform-features-list">
                                            <div class="platform-feature-item">
                                                <img src="assets/images/ic-outline-gpp-good2.svg" alt="">
                                                <span>Customer profile based personalized policy recommendations</span>
                                            </div>
                                            <div class="platform-feature-item">
                                                <img src="assets/images/group2.svg" alt="">
                                                <span>Faster quote-to-close cycles for agents and POSPs</span>
                                            </div>
                                            <div class="platform-feature-item">
                                                <img src="assets/images/material-symbols-money-bag-outline2.svg" alt="">
                                                <span>More consistent, higher-quality customer conversations at
                                                    scale</span>
                                            </div>
                                            <div class="platform-feature-item">
                                                <img src="assets/images/mdi-invoice-fast-outline2.svg" alt="">
                                                <span>Productive brokerage that does more business in less time</span>
                                            </div>
                                        </div>
                                        <a href="#" class="btn-link-custom">
                                            Explore More
                                ...
                                <div class="col-lg-6">
                                    <div class="platform-card-image">
                                        <img src="assets/images/insurance-policy-management-software-12.png"
                                            alt="Lifesciences policy management dashboard">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- Card 4: Corporate Wellness -->
                    <div class="platform-deck-card pos-3" data-index="3" data-category="wellness">
                        <div class="platform-card">
                            <div class="row g-0 align-items-center">
                                <div class="col-lg-6">
                                    <div class="platform-card-body">
                                        <span class="platform-card-label">Corporate Wellness</span>
                                        <h3 class="platform-card-title">Adapt with Speed. <span
                                                class="text-primary-custom">Scale with Ease.</span></h3>
                                        <p class="platform-card-desc">Trusted by leading insurers worldwide to
                                            accelerate product innovation, elevate underwriting accuracy, and deliver
                                ...
                                <div class="col-lg-6">
                                    <div class="platform-card-image">
                                        <img src="assets/images/insurance-policy-management-software-10.png"
                                            alt="Corporate wellness management dashboard">
                                    </div>
                                </div>
                            </div>
                        </div>
...
<section class="lob-section section-padding" id="lob" aria-label="Lines of business" data-aos="fade-up">
    <div class="container">
        <div class="lob-content">
            ...
            <div class="lob-slider-area" aria-label="Insurance products showcase" data-aos="fade-left" data-aos-delay="150">
    ...
    <div class="container">
        <div class="row align-items-center mb-4" data-aos="fade-up">
            <div class="col-lg-8">
                ...
                <p class="section-desc">Insurance teams can't afford disconnected systems, manual workflows, or delayed decisions. FondosTech unifies claims, operations, accounts, and sales into one intelligent platform.</p>
            </div>
            <div class="col-lg-4 text-lg-end mt-3 mt-lg-0">
                ...
                <div class="workflow-card legacy-workflow-card">
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            ...
                            <p class="workflow-card-desc">Brokers and agents waste 60%+ of their time jumping between Excel sheets, manual insurer portals, and disconnected messaging tools.</p>
                        ...
                        <div class="col-lg-6 mt-4 mt-lg-0">
                            <div class="workflow-graphic-box legacy-graphic">
                                <div class="legacy-animated-graphic">
                                    <svg viewBox="0 0 700 350" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-100 h-auto">
                                        <defs>
                                            ...
                                            <filter id="legShadow" x="-10%" y="-10%" width="120%" height="130%">
                                                <feDropShadow dx="0" dy="4" stdDeviation="6" flood-color="#086AD8" flood-opacity="0.18"/>
                                            </filter>
                                        </defs>

                                        <!-- Card Canvas Background -->
                                        <rect width="700" height="350" rx="16" fill="#F8FBFF"/>
                                        <rect x="1" y="1" width="698" height="348" rx="15" stroke="#CEE4FD" stroke-width="1.5"/>
                                        
                                        <!-- Top Pill Header: WITHOUT FONDOS TECH -->
                                        <rect x="260" y="12" width="180" height="24" rx="12" fill="#64748B"/>
                                        <text x="350" y="28" text-anchor="middle" font-size="10" font-weight="700" fill="#FFFFFF" letter-spacing="0.04em">WITHOUT FONDOS TECH</text>

                                        <!-- Left Side Vertical Modules -->
                                        <!-- 1. IC-Claims -->
                                        <g filter="url(#legShadow)">
                                            <rect x="25" y="45" width="115" height="40" rx="8" fill="url(#legNodeGrad)"/>
                                            <text x="82.5" y="70" text-anchor="middle" font-size="11" font-weight="700" fill="#FFFFFF">IC-Claims</text>
                                        </g>

                                        <!-- 2. IC-Operations -->
                                        <g filter="url(#legShadow)">
                                            <rect x="25" y="115" width="115" height="40" rx="8" fill="url(#legNodeGrad)"/>
                                            <text x="82.5" y="140" text-anchor="middle" font-size="11" font-weight="700" fill="#FFFFFF">IC-Operations</text>
                                        </g>

                                        <!-- 3. IC-Account -->
                                        <g filter="url(#legShadow)">
                                            <rect x="25" y="185" width="115" height="40" rx="8" fill="url(#legNodeGrad)"/>
                                            <text x="82.5" y="210" text-anchor="middle" font-size="11" font-weight="700" fill="#FFFFFF">IC-Account</text>
                                        </g>

                                        <!-- 4. IC-Sales -->
                                        <g filter="url(#legShadow)">
                                            <rect x="25" y="255" width="115" height="40" rx="8" fill="url(#legNodeGrad)"/>
                                            <text x="82.5" y="280" text-anchor="middle" font-size="11" font-weight="700" fill="#FFFFFF">IC-Sales</text>
                                        </g>

                                        <!-- Left Connector Badges & Flow Lines -->
                                        <!-- Claims Connector -->
                                        <rect x="148" y="53" width="125" height="24" rx="12" fill="#EEF5FC" stroke="#CEE4FD"/>
                                        <text x="210.5" y="69" text-anchor="middle" font-size="9" font-weight="700" fill="#086AD8">= Quote + Payment =</text>
                                        <path d="M273 65 H315 V135 H330" stroke="#086AD8" stroke-width="1.5" stroke-dasharray="5 4" class="flowing-blue-line"/>

                                        <!-- Operations Connector -->
                                        <rect x="148" y="123" width="140" height="24" rx="12" fill="#EEF5FC" stroke="#CEE4FD"/>
                                        <text x="218" y="139" text-anchor="middle" font-size="9" font-weight="700" fill="#086AD8">= Policy Endorsement =</text>
                                        <path d="M288 135 H330" stroke="#086AD8" stroke-width="1.5" stroke-dasharray="5 4" class="flowing-blue-line"/>

                                        <!-- Account Connector -->
                                        <rect x="148" y="193" width="125" height="24" rx="12" fill="#EEF5FC" stroke="#CEE4FD"/>
                                        <text x="210.5" y="209" text-anchor="middle" font-size="9" font-weight="700" fill="#086AD8">= Billing + Payment =</text>
                                        <path d="M273 205 H315 V175 H330" stroke="#086AD8" stroke-width="1.5" stroke-dasharray="5 4" class="flowing-blue-line"/>

                                        <!-- Sales Connector -->
                                        <rect x="148" y="263" width="165" height="24" rx="12" fill="#EEF5FC" stroke="#CEE4FD"/>
                                        <text x="230.5" y="279" text-anchor="middle" font-size="9" font-weight="700" fill="#086AD8">= Claim Doc + Processing =</text>
                                        <path d="M313 275 H330 V190" stroke="#086AD8" stroke-width="1.5" stroke-dasharray="5 4" class="flowing-blue-line"/>

                                        <!-- Center Box: Insurance Intermediary -->
                                        <g filter="url(#legShadow)">
                                            <rect x="330" y="115" width="125" height="80" rx="10" fill="url(#legNodeGrad)"/>
                                            <text x="392.5" y="152" text-anchor="middle" font-size="12" font-weight="800" fill="#FFFFFF">Insurance</text>
                                            <text x="392.5" y="169" text-anchor="middle" font-size="12" font-weight="800" fill="#FFFFFF">Intermediary</text>
                                        </g>

                                        <!-- Right Connector Badges & Lines -->
                                        <!-- Top Solicit Connector -->
                                        <rect x="463" y="126" width="70" height="22" rx="11" fill="#EEF5FC" stroke="#CEE4FD"/>
                                        <text x="498" y="141" text-anchor="middle" font-size="9" font-weight="700" fill="#086AD8">= Solicit &gt;</text>
                                        <path d="M533 137 H545" stroke="#086AD8" stroke-width="1.5" stroke-dasharray="5 4" class="flowing-blue-line"/>

                                        <!-- Bottom Request Connector -->
                                        <rect x="463" y="162" width="135" height="22" rx="11" fill="#EEF5FC" stroke="#CEE4FD"/>
                                        <text x="530.5" y="177" text-anchor="middle" font-size="9" font-weight="700" fill="#086AD8">= Req + Info + Payment &gt;</text>
                                        <path d="M598 173 H545" stroke="#086AD8" stroke-width="1.5" stroke-dasharray="5 4" class="flowing-blue-line"/>

                                        <!-- Right Box: Customer -->
                                        <g filter="url(#legShadow)">
                                            <rect x="545" y="115" width="125" height="80" rx="10" fill="url(#legNodeGrad)"/>
                                            <text x="607.5" y="161" text-anchor="middle" font-size="14" font-weight="800" fill="#FFFFFF">Customer</text>
                                        </g>

                                        <!-- Bottom Warning Highlights -->
                                        <rect x="25" y="310" width="195" height="26" rx="13" fill="#FFF5F5" stroke="#F5C2C7"/>
                                        <text x="122.5" y="327" text-anchor="middle" font-size="10" font-weight="700" fill="#DC3545">✕ Manual Re-Entry Risk</text>

                                        <rect x="250" y="310" width="195" height="26" rx="13" fill="#FFF5F5" stroke="#F5C2C7"/>
                                        <text x="347.5" y="327" text-anchor="middle" font-size="10" font-weight="700" fill="#DC3545">⏳ 7-14 Day Processing Delay</text>

                                        <rect x="475" y="310" width="195" height="26" rx="13" fill="#FFF5F5" stroke="#F5C2C7"/>
                                        <text x="572.5" y="327" text-anchor="middle" font-size="10" font-weight="700" fill="#DC3545">⚠️ Siloed Portal Operations</text>
                                    </svg>
                                </div>
                            </div>
                        </div>
                ...
                <div class="workflow-card smart-workflow-card">
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            ...
                            <p class="workflow-card-desc">Unifies quoting, POSP onboarding, claims reconciliation, and IRDAI compliance on a single AI-powered platform.</p>
                            <div class="workflow-points-list">
                        ...
                        <div class="col-lg-6 mt-4 mt-lg-0">
                            <div class="workflow-graphic-box smart-graphic">
                                <div class="smart-animated-graphic">
                                    <svg viewBox="0 0 540 280" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-100 h-auto">
                                        <!-- Background Card -->
                                        ...
                                        <text x="270" y="30" text-anchor="middle" font-size="10" font-weight="700" fill="#FFFFFF">WITH FONDOS TECH</text>

                                        <!-- Central Animated Blue Pulse Core -->
                                        <circle cx="270" cy="120" r="50" fill="none" stroke="#3D8DE5" stroke-width="1.5" class="pulsing-core-ring"/>
                                        <circle cx="270" cy="120" r="38" fill="none" stroke="#086AD8" stroke-width="1" class="pulsing-core-ring-2"/>
                                        <circle cx="270" cy="120" r="28" fill="#086AD8"/>
                                        <text x="270" y="127" text-anchor="middle" font-size="18" font-weight="800" fill="#FFFFFF">FT</text>

                                        <!-- Left Modules (Connected to Core) -->
                                        <g class="smart-left-nodes">
                                            <!-- Claims Node -->
                                            <rect x="25" y="52" width="115" height="36" rx="8" fill="#FFFFFF" stroke="#086AD8" stroke-width="1.5"/>
                                            <text x="82.5" y="74" text-anchor="middle" font-size="10" font-weight="700" fill="#086AD8">📋 IC-Claims</text>

                                            <!-- Ops Node -->
                                            <rect x="25" y="98" width="115" height="36" rx="8" fill="#FFFFFF" stroke="#086AD8" stroke-width="1.5"/>
                                            <text x="82.5" y="120" text-anchor="middle" font-size="10" font-weight="700" fill="#086AD8">⚙️ IC-Operations</text>

                                            <!-- Account Node -->
                                            <rect x="25" y="144" width="115" height="36" rx="8" fill="#FFFFFF" stroke="#086AD8" stroke-width="1.5"/>
                                            <text x="82.5" y="166" text-anchor="middle" font-size="10" font-weight="700" fill="#086AD8">💳 IC-Account</text>

                                            <!-- Sales Node -->
                                            <rect x="25" y="190" width="115" height="34" rx="8" fill="#FFFFFF" stroke="#086AD8" stroke-width="1.5"/>
                                            <text x="82.5" y="211" text-anchor="middle" font-size="10" font-weight="700" fill="#086AD8">📈 IC-Sales</text>
                                        </g>

                                        <!-- Right Modules (Connected to Core) -->
                                        <g class="smart-right-nodes">
                                            <!-- Intermediary Node -->
                                            <rect x="400" y="75" width="115" height="42" rx="8" fill="#FFFFFF" stroke="#086AD8" stroke-width="1.5"/>
                                            <text x="457.5" y="94" text-anchor="middle" font-size="10" font-weight="700" fill="#086AD8">Insurance</text>
                                            <text x="457.5" y="108" text-anchor="middle" font-size="9" fill="#495057">Intermediary</text>

                                            <!-- Customer Node -->
                                            <rect x="400" y="135" width="115" height="42" rx="8" fill="#FFFFFF" stroke="#086AD8" stroke-width="1.5"/>
                                            <text x="457.5" y="154" text-anchor="middle" font-size="10" font-weight="700" fill="#086AD8">👥 End Customer</text>
                                            <text x="457.5" y="168" text-anchor="middle" font-size="9" fill="#495057">Instant Service</text>
                                        </g>

                                        <!-- Animated Flowing Blue Lines into Core -->
                                        <path d="M140 70 H195 V120 H220" stroke="#086AD8" stroke-width="1.5" stroke-dasharray="4 3" class="flowing-blue-line"/>
                                        <path d="M140 116 H220" stroke="#086AD8" stroke-width="1.5" stroke-dasharray="4 3" class="flowing-blue-line"/>
                                        <path d="M140 162 H195 V120 H220" stroke="#086AD8" stroke-width="1.5" stroke-dasharray="4 3" class="flowing-blue-line"/>
                                        <path d="M400 96 H345 V120 H320" stroke="#086AD8" stroke-width="1.5" stroke-dasharray="4 3" class="flowing-blue-line"/>
                                        <path d="M400 156 H345 V120 H320" stroke="#086AD8" stroke-width="1.5" stroke-dasharray="4 3" class="flowing-blue-line"/>

                                        <!-- Bottom Feature Highlights -->
                                        <rect x="15" y="242" width="160" height="26" rx="13" fill="#FFFFFF" stroke="#CEE4FD"/>
                                        <text x="95" y="259" text-anchor="middle" font-size="10" font-weight="700" fill="#086AD8">✓ Unified Process</text>

                                        <rect x="190" y="242" width="160" height="26" rx="13" fill="#FFFFFF" stroke="#CEE4FD"/>
                                        <text x="270" y="259" text-anchor="middle" font-size="10" font-weight="700" fill="#086AD8">👁 Real-time Visibility</text>

                                        <rect x="365" y="242" width="160" height="26" rx="13" fill="#FFFFFF" stroke="#CEE4FD"/>
                                        <text x="445" y="259" text-anchor="middle" font-size="10" font-weight="700" fill="#086AD8">⚡ Faster Turnaround</text>
                                    </svg>
                                </div>
                            </div>
                        </div>
...
<!-- ============================================= -->
<section class="claims-section section-padding d-none" id="claims" aria-label="Government claims management" data-aos="fade-up">
...
<!-- ============================================= -->
<section class="testimonials-section section-padding" id="testimonials" aria-label="Customer testimonials" data-aos="fade-up">
    <!-- Centered Header -->
            ...
            <div class="testimonials-track" id="testimonials-track">
                ...
                <div class="testimonial-card">
                    ...
                    <p class="testimonial-text">
                        <span>“</span>
                        FondosTech has revolutionized our insurance operations with their seamless API integrations and user-friendly platforms. Their timely delivery and dedicated support team ensured a smooth onboarding process, helping us achieve operational efficiency in record time.
                        <span>”</span>
                    </p>
                ...
                <div class="testimonial-card">
                    ...
                    <p class="testimonial-text">
                        <span>“</span>
                        The journey with FondosTech has been outstanding. From timely delivery to exceptional client support, they’ve consistently gone above and beyond to help us achieve our goals.
                        <span>”</span>
                    </p>
                    <div class="testimonial-divider"></div>
                    <div class="testimonial-author">
                ...
                <div class="testimonial-card">
                    ...
                    <p class="testimonial-text">
                        <span>“</span>
                        The team at FondosTech truly understands the complexities of insurance distribution. Their robust solutions for quote generation and policy issuance have streamlined our workflows, while their exceptional post-implementation support makes them a trusted partner.
                        <span>”</span>
                    </p>
                    <div class="testimonial-divider"></div>
                    <div class="testimonial-author">
                        ...
                        <img src="assets/images/clip-path-group1.svg" alt="Company logo" class="testimonial-author-logo">
                    </div>
                </div>
                ...
                <div class="testimonial-card">
                    ...
                    <p class="testimonial-text">
                        <span>“</span>
                        FondosTech’s claims management module has transformed the way we handle customer requests. The platform is intuitive and efficient, and their team is always available to provide guidance whenever needed. Truly a remarkable experience!
                        <span>”</span>
                    </p>
                    <div class="testimonial-divider"></div>
                    <div class="testimonial-author">
        ...
        <div class="testimonial-nav-btns d-inline-flex align-items-center justify-content-center gap-3">
            <button class="testimonial-nav-btn" id="testimonial-prev" aria-label="Previous testimonial">
                <svg viewBox="0 0 9 14" fill="none" width="10" height="14" xmlns="http://www.w3.org/2000/svg">
                    <path d="M8 1L2 7L8 13" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
            </button>
            ...
            <div class="col-lg-5 col-md-12 faq-left-column">
                <div class="faq-left-content">
                    ...
                    <p class="section-desc mb-4">
                        Find trusted answers about our insurance broker software, POSP management, claims and compliance.
                    </p>
                    <a href="contact.php" class="btn btn-primary-custom rounded-pill px-4 py-3 d-inline-flex align-items-center gap-2 font-weight-bold shadow-sm">
                        <span>Read More</span>
                        <svg viewBox="0 0 9 14" fill="none" width="10" height="14" xmlns="http://www.w3.org/2000/svg">
                            <path d="M1 1L7 7L1 13" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                ...
                <div class="accordion faq-accordion-custom" id="faqAccordion">
                    ...
                    <div class="accordion-item faq-card-item" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <div id="faq1" class="accordion-collapse collapse show" data-bs-parent="#faqAccordion">
                            <div class="accordion-body">
                                Insurance software is a digital platform that helps insurance brokers and POSPs manage the full policy lifecycle — quoting, POSP and client management, claims, commission reconciliation and regulatory compliance — from one system instead of multiple disconnected tools.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item faq-card-item" data-aos="fade-up" data-aos-delay="150">
                        ...
                        <div id="faq2" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                            <div class="accordion-body">
                                Yes, FondosTech leverages AI and machine learning algorithms for automated quote extraction, intelligent claims assessment, fraud detection, and automated reconciliation across insurer portals.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item faq-card-item" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <div id="faq3" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                            <div class="accordion-body">
                                Absolutely. FondosTech is built with modular architecture, making it scalable for individual brokers, growing agencies, and large enterprise insurance brokerages.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item faq-card-item" data-aos="fade-up" data-aos-delay="250">
                        ...
                        <div id="faq4" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                            <div class="accordion-body">
                                Yes, our motor insurance module integrates directly with VAHAN and RTO databases for instant vehicle detail lookup and instant quote generation.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item faq-card-item" data-aos="fade-up" data-aos-delay="300">
                        ...
                        <div id="faq5" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                            <div class="accordion-body">
                                Yes, FondosTech is fully compliant with IRDAI regulations, including mandatory audit logging, POSP training tracking, client data protection, and commission cap compliance.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item faq-card-item" data-aos="fade-up" data-aos-delay="350">
                        ...
                        <div id="faq6" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                            <div class="accordion-body">
                                Unlike generic CRMs, FondosTech is purpose-built for insurance distribution, featuring deep insurer portal API integrations, multi-line quote engines, end-to-end policy endorsement, and automated payout calculations.
                            </div>
                        </div>
                    </div>
                </div>
